...
@section('content_admin')
	...
	<div class="market-updates">
          ...
          <i class='bx bxs-smile' style="font-size:40px;color:#fff;"></i>
					</div>
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-4 market-update-right">
          <i class='bx bxs-user' style="font-size:40px;color:#fff;"></i>
					</div>
					<div class="col-md-8 market-update-left">
					<h4>Users</h4>
						<h3>1,250</h3>
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-3">
					<div class="col-md-4 market-update-right">
          <i class='bx bx-dollar' style="font-size:40px;color:#fff;"></i>
					</div>
					<div class="col-md-8 market-update-left">
						<h4>Sales</h4>
						<h3>1,500</h3>
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-4">
					<div class="col-md-4 market-update-right">
          <i class='bx bxs-cart-alt' style='color:#fff;font-size:40px'  ></i>
					</div>
					<div class="col-md-8 market-update-left">
						<h4>Orders</h4>
						<h3>1,500</h3>
